...
@section ('url')
https://khactrieucamera{{$path}}
@endsection

@section ('img')
https://khactrieucamera.ga/source/11082451_1070414206308597_1185469358993272387_n.jpg!!}
@endsection
@section ('title')
    Trang chủ
@endsection
        ...
        @foreach($sanpham as $sp)
            <div class="sanpham">
                ...
                <div class="hide-show">
                    ...
                    @if($sp->KhuyenMai != 0)
                    <div class="gia">{{number_format(((100 - $sp->KhuyenMai)/100) * $sp->Gia)}} VND</div>
                        <!--giam gia-->
